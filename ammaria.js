...
(function() {
  ...
  CF.registerModule({
    ...
    description: 'Regional edges, hindrances, equipment, and characters from the Ammaria supplement.',
    alwaysOn: false,
    colour: '#C49A4A',
    ...
    // ── CHARACTERS (20) ──
    characters: [] // Characters now live in remote Gist — loaded by Character Vault
  });
})();
